      ...
      <div className="container-fluid">
        <div className="row">
          <div className="card-body p-0">
            <h1 style={{fontSize:"40px"}}>Citas agendadas</h1>
              ...
              <div className="card-body">
                <table id="citasTable" className="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td>
                        <span className="badge badge-primary">Asignada</span>
                      </td>
                      <td className="project-actions text-right d-flex justify-content-around" >
                          <Link to="/citas/ver"  className="btn btn-primary btn-sm">
                              <i className="fas fa-eye mr-1">
                              </i>
                              Ver
                          </Link>
                          <Link to="/citas/editar" className="btn btn-info btn-sm" >
